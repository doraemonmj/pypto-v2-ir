...
from fuzz.src.mutile_kernel_test_generator import MultiKernelTestGenerator  # noqa: E402
    ...
    all_configs = [
        {
            ...
            "description": "Simple sequential execution: 2 kernels, same dimension inputs",
        },
    ]
